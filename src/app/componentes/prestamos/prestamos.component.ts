  ...
  pre = {
    ...
    operar() {
      switch (this.seleccionada) {
        case 'pagregar' : this.prestarlibro(); this.resultado = 'prestamo agregado con exito'; break;
        case 'pdevuelto' : this.resultado = 'el prestamo se a devuelto';  break;
        case 'prenovar' : this.resultado = 'libro renovado con exito';  break;
        case 'pconsultar' : this.resultado = 'consultar prestamos con exito'; break;
      }
    }
