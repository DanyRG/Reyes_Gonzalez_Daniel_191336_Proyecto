  ...
  lib = {
    ...
    operar() {
      switch (this.seleccionada) {
        ...
        case 'eliminarl' : this.resultado = 'libro se a eliminado';  break;
        case 'modificarl' : this.resultado = 'libro se a modificado';  break;
        case 'consultarl' : this.resultado = 'libro se a consultado'; break;
      }
    }
